...
Or manually copy the `codexbar/` folder into your Noctalia plugins directory.
...
Inspired by [noctalia-codex-usage](https://github.com/rayoplateado/noctalia-codex-usage) by [Ray García](https://github.com/rayoplateado).

Built on top of [CodexBar](https://github.com/steipete/CodexBar) CLI by [Peter Steinberger](https://github.com/steipete).
